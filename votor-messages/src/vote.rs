...
#[cfg_attr(
    ...
    frozen_abi(
        ...
        abi_digest = "8pfmJycM2B68uFujLA3g7gMTcwKg3LpjM6LUr4FnWwPW"
    )
)]
...
#[cfg_attr(
    ...
    frozen_abi(
        ...
        abi_digest = "HsEjm1ae7RiMvvDDFZAGAQascVYkUXChcBMJnKR2ZK8S"
    )
)]
#[derive(Clone, Copy, Debug, PartialEq, Default, Serialize, Deserialize)]
...
#[cfg_attr(
    ...
    frozen_abi(
        ...
        abi_digest = "CHeCHQrdFMKNqLpXvA2w98rU5kFvQZ7Ni1RJfvNfAjkj"
    )
)]
#[derive(Clone, Copy, Debug, PartialEq, Default, Serialize, Deserialize)]
