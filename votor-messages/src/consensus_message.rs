...
#[cfg_attr(
    ...
    frozen_abi(
        ...
        abi_digest = "88fMdiPifxEXgxsrMw8RbVaoGmDBLFGU4GMkWxYWDpVV"
    )
)]
...
#[cfg_attr(
    ...
    frozen_abi(
        ...
        abi_digest = "8fj1ztEQs5qyzemcwWjrm4tcThDmfxocMswWqrRmuZMy"
    )
)]
...
#[cfg_attr(
    ...
    frozen_abi(
        ...
        abi_digest = "25sxqsQ7zQe7LbzGsoT89253Eu3humrwTawQ1rEbRY5f"
    )
)]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[cfg_attr(
    ...
    frozen_abi(
        ...
        abi_digest = "Aq9wuZAzgxWy4SAWpjPJrHaCeyZtWhPbMxrcTYVDASwU"
    )
)]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
