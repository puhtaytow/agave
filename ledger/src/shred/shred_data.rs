...
impl ShredData {
    ...
    pub(crate) fn resize_stored_shred(shred: Vec<u8>) -> Result<Vec<u8>, Error> {
        match shred::layout::get_shred_variant(&shred)? {
            // TODO: removed "ShredVariant::LegacyCode | "
    ...
    pub fn capacity(
        ...
        match merkle_variant {
            // TODO: fix the None variant capacity perhaps maybe
            None => merkle::ShredData::capacity(6, true, false), // Default: proof_size=6, chained=true, resigned=false
