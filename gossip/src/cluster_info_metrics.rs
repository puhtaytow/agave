...
pub struct GossipStats {
    pub bad_prune_destination: Counter,
    pub entrypoint2: Counter,
    pub entrypoint: Counter,
    pub epoch_slots_filled: Counter,
    pub epoch_slots_lookup: Counter,
    pub filter_crds_values_dropped_requests: Counter,
    pub filter_crds_values_dropped_values: Counter,
    pub filter_pull_response: Counter,
    pub generate_prune_messages: Counter,
    pub generate_pull_responses: Counter,
    pub get_votes: Counter,
    pub get_votes_count: Counter,
    pub gossip_listen_loop_iterations_since_last_report: Counter,
    pub gossip_listen_loop_time: Counter,
    pub gossip_packets_dropped_count: Counter,
    pub gossip_pull_request_dropped_requests: Counter,
    pub gossip_pull_request_no_budget: Counter,
    pub gossip_pull_request_sent_bytes: Counter,
    pub gossip_transmit_loop_iterations_since_last_report: Counter,
    pub gossip_transmit_loop_time: Counter,
    pub gossip_transmit_packets_dropped_count: Counter,
    pub handle_batch_ping_messages_time: Counter,
    pub handle_batch_pong_messages_time: Counter,
    pub handle_batch_prune_messages_time: Counter,
    pub handle_batch_pull_requests_time: Counter,
    pub handle_batch_pull_responses_time: Counter,
    pub handle_batch_push_messages_time: Counter,
    pub new_pull_requests: Counter,
    pub new_push_requests2: Counter,
    pub new_push_requests: Counter,
    pub num_unverifed_gossip_addrs: Counter,
    pub packets_received_count: Counter,
    pub packets_received_ping_messages_count: Counter,
    pub packets_received_pong_messages_count: Counter,
    pub packets_received_prune_messages_count: Counter,
    pub packets_received_pull_requests_count: Counter,
    pub packets_received_pull_responses_count: Counter,
    pub packets_received_push_messages_count: Counter,
    pub packets_received_unknown_count: Counter,
    pub packets_received_verified_count: Counter,
    pub packets_sent_ping_messages_count: Counter,
    pub packets_sent_pong_messages_count: Counter,
    pub packets_sent_prune_messages_count: Counter,
    pub packets_sent_pull_requests_count: Counter,
    pub packets_sent_pull_responses_count: Counter,
    pub packets_sent_push_messages_count: Counter,
    pub process_gossip_packets_time: Counter,
    pub process_prune: Counter,
    pub process_pull_response: Counter,
    pub process_pull_response_count: Counter,
    pub process_pull_response_fail_insert: Counter,
    pub process_pull_response_fail_timeout: Counter,
    pub process_pull_response_len: Counter,
    pub process_pull_response_success: Counter,
    pub process_push_message: Counter,
    pub prune_message_len: Counter,
    pub prune_message_timeout: Counter,
    pub prune_received_cache: Counter,
    pub pull_from_entrypoint_count: Counter,
    pub pull_request_ping_pong_check_failed_count: Counter,
    pub purge: Counter,
    pub purge_count: Counter,
    pub push_fanout_num_entries: Counter,
    pub push_fanout_num_nodes: Counter,
    pub push_message_value_count: Counter,
    pub push_vote_read: Counter,
    pub repair_peers: Counter,
    pub save_contact_info_time: Counter,
    pub skip_pull_response_shred_version: Counter,
    pub skip_pull_shred_version: Counter,
    pub skip_push_message_shred_version: Counter,
    pub trim_crds_table: Counter,
    pub trim_crds_table_failed: Counter,
    pub trim_crds_table_purged_values_count: Counter,
    pub tvu_peers: Counter,
    pub verify_gossip_packets_time: Counter,
    pub window_request_loopback: Counter,
}
